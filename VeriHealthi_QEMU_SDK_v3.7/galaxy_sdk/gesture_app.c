...
/**
 * @brief Bluetooth sample
 * @defgroup bluetooth_sample Bluetooth sample
 * @{
 * @}
 */

/**
 * @brief Bluetooth peripheral demonstration.
 * @details This sample demonstrates the usage of Bluetooth peripheral role for advertising
 *          and connecting to Bluetooth devices.
 * @defgroup peripheral PERIPHERAL
 * @ingroup bluetooth_sample
 * @{
 * @}
 */
...
void ble_app_start(void)
{
    ...
    bt_bas_set_gesture_char("clench");
}
