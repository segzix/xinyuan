 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_BLUETOOTH_H_
#define VSBT_INCLUDE_BLUETOOTH_BLUETOOTH_H_
...
/* ensure vsbt_config.h is included. */
BUILD_ASSERT(CONFIG_BT_HCI_HOST == 1,
    "Please check the correct vsbt_config.h is included");
...
enum {
	 ...
	 */
	BT_LE_ADV_OPT_CONNECTABLE = BTBIT(0),
	 ...
	 */
	BT_LE_ADV_OPT_ONE_TIME = BTBIT(1),
	 ...
	 */
	BT_LE_ADV_OPT_CONN = BTBIT(0) | BTBIT(1),
	 ...
	 */
	BT_LE_ADV_OPT_USE_IDENTITY = BTBIT(2),
	 ...
	 * @endcode
	 */
	BT_LE_ADV_OPT_USE_NAME = BTBIT(3),
	 ...
	 * will be used.
	 */
	BT_LE_ADV_OPT_DIR_MODE_LOW_DUTY = BTBIT(4),
	 ...
	 */
	BT_LE_ADV_OPT_SCANNABLE = BTBIT(9),
	 ...
	 */
	BT_LE_ADV_OPT_EXT_ADV = BTBIT(10),
	 ...
	 * @note Requires @ref BT_LE_ADV_OPT_EXT_ADV
	 */
	BT_LE_ADV_OPT_ANONYMOUS = BTBIT(13),
	 ...
	 * @note Requires @ref BT_LE_ADV_OPT_EXT_ADV
	 */
	BT_LE_ADV_OPT_USE_TX_POWER = BTBIT(14),

	/** Disable advertising on channel index 37. */
	BT_LE_ADV_OPT_DISABLE_CHAN_37 = BTBIT(15),

	/** Disable advertising on channel index 38. */
	BT_LE_ADV_OPT_DISABLE_CHAN_38 = BTBIT(16),

	/** Disable advertising on channel index 39. */
	BT_LE_ADV_OPT_DISABLE_CHAN_39 = BTBIT(17),
	 ...
	 */
	BT_LE_ADV_OPT_FORCE_NAME_IN_AD = BTBIT(18),
	 ...
	 */
	BT_LE_ADV_OPT_USE_NRPA = BTBIT(19),

#if defined(CONFIG_BT_MESH_CLOCK_MODEL)
	BT_LE_ADV_OPT_TIME_REPORT = BIT(31),
#endif
};
...
enum {
	 ...
	 * @note Requires @ref BT_LE_ADV_OPT_EXT_ADV
	 */
	BT_LE_PER_ADV_OPT_USE_TX_POWER = BTBIT(1),
	 ...
	 * @note Requires @ref BT_LE_ADV_OPT_EXT_ADV
	 */
	BT_LE_PER_ADV_OPT_INCLUDE_ADI = BTBIT(2),
};
 ...
 *                       in the controller. Up to controllers code returned in
...
enum {
	 ...
	 * are ignored.
	 */
	BT_LE_PER_ADV_SYNC_OPT_USE_PER_ADV_LIST = BTBIT(0),
	 ...
	 */
	BT_LE_PER_ADV_SYNC_OPT_REPORTING_INITIALLY_DISABLED = BTBIT(1),

	/** Filter duplicate Periodic Advertising reports */
	BT_LE_PER_ADV_SYNC_OPT_FILTER_DUPLICATE = BTBIT(2),

	/** Sync with Angle of Arrival (AoA) constant tone extension */
	BT_LE_PER_ADV_SYNC_OPT_DONT_SYNC_AOA = BTBIT(3),

	/** Sync with Angle of Departure (AoD) 1 us constant tone extension */
	BT_LE_PER_ADV_SYNC_OPT_DONT_SYNC_AOD_1US = BTBIT(4),

	/** Sync with Angle of Departure (AoD) 2 us constant tone extension */
	BT_LE_PER_ADV_SYNC_OPT_DONT_SYNC_AOD_2US = BTBIT(5),

	/** Do not sync to packets without a constant tone extension */
	BT_LE_PER_ADV_SYNC_OPT_SYNC_ONLY_CONST_TONE_EXT = BTBIT(6),
};
...
enum {
	 ...
	 **/
	BT_LE_PER_ADV_SYNC_TRANSFER_OPT_SYNC_NO_AOA = BTBIT(0),
	 ...
	 */
	BT_LE_PER_ADV_SYNC_TRANSFER_OPT_SYNC_NO_AOD_1US = BTBIT(1),
	 ...
	 * constant tone extension
	 */
	BT_LE_PER_ADV_SYNC_TRANSFER_OPT_SYNC_NO_AOD_2US = BTBIT(2),

	/** Only sync to packets with constant tone extension */
	BT_LE_PER_ADV_SYNC_TRANSFER_OPT_SYNC_ONLY_CTE = BTBIT(3),
	 ...
	 */
	BT_LE_PER_ADV_SYNC_TRANSFER_OPT_REPORTING_INITIALLY_DISABLED = BTBIT(4),
	 ...
	 */
	BT_LE_PER_ADV_SYNC_TRANSFER_OPT_FILTER_DUPLICATES = BTBIT(5),
};
...
enum {
	...
	/** Filter duplicates. */
	BT_LE_SCAN_OPT_FILTER_DUPLICATE = BTBIT(0),

	/** Filter using filter accept list. */
	BT_LE_SCAN_OPT_FILTER_ACCEPT_LIST = BTBIT(1),

	/** Enable scan on coded PHY (Long Range).*/
	BT_LE_SCAN_OPT_CODED = BTBIT(2),
...
#endif /* VSBT_INCLUDE_BLUETOOTH_BLUETOOTH_H_ */
