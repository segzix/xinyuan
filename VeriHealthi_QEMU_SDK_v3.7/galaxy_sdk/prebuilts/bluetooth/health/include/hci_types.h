 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_HCI_TYPES_H_
#define VSBT_INCLUDE_BLUETOOTH_HCI_TYPES_H_
...
/* Supported Commands */
#define BT_CMD_TEST(cmd, octet, bit)            (cmd[octet] & BTBIT(bit))
#define BT_CMD_LE_STATES(cmd)                   BT_CMD_TEST(cmd, 28, 3)

#define BT_FEAT_TEST(feat, page, octet, bit)    (feat[page][octet] & BTBIT(bit))
...
#define BT_HCI_LINK_POLICY_SETTINGS_ENABLE_ROLE_SWITCH  BTBIT(0)
#define BT_HCI_LINK_POLICY_SETTINGS_ENABLE_HOLD_MODE    BTBIT(1)
#define BT_HCI_LINK_POLICY_SETTINGS_ENABLE_SNIFF_SWITCH BTBIT(2)
...
#define BT_COD_VALID(cod) ((0 == (cod[0] & (BTBIT(0) | BTBIT(1)))) ? true : false)
...
#define BT_HCI_CODEC_TRANSPORT_MASK_BREDR_ACL BTBIT(0)
#define BT_HCI_CODEC_TRANSPORT_MASK_BREDR_SCO BTBIT(1)
#define BT_HCI_CODEC_TRANSPORT_MASK_LE_CIS    BTBIT(2)
#define BT_HCI_CODEC_TRANSPORT_MASK_LE_BIS    BTBIT(3)
...
#define BT_HCI_LE_PHY_TX_ANY                    BTBIT(0)
#define BT_HCI_LE_PHY_RX_ANY                    BTBIT(1)

#define BT_HCI_LE_PHY_PREFER_1M                 BTBIT(0)
#define BT_HCI_LE_PHY_PREFER_2M                 BTBIT(1)
#define BT_HCI_LE_PHY_PREFER_CODED              BTBIT(2)
...
#define BT_HCI_LE_ADV_PROP_CONN                 BTBIT(0)
#define BT_HCI_LE_ADV_PROP_SCAN                 BTBIT(1)
#define BT_HCI_LE_ADV_PROP_DIRECT               BTBIT(2)
#define BT_HCI_LE_ADV_PROP_HI_DC_CONN           BTBIT(3)
#define BT_HCI_LE_ADV_PROP_LEGACY               BTBIT(4)
#define BT_HCI_LE_ADV_PROP_ANON                 BTBIT(5)
#define BT_HCI_LE_ADV_PROP_TX_POWER             BTBIT(6)
#if defined(CONFIG_BT_MESH_CLOCK_MODEL)
#define BT_HCI_LE_ADV_PROP_TIME_REPORT          BTBIT(15)
#endif
...
#define BT_HCI_LE_SET_PER_ADV_ENABLE_ENABLE     BTBIT(0)
#define BT_HCI_LE_SET_PER_ADV_ENABLE_ADI        BTBIT(1)
...
#define BT_HCI_LE_EXT_SCAN_PHY_1M               BTBIT(0)
#define BT_HCI_LE_EXT_SCAN_PHY_2M               BTBIT(1)
#define BT_HCI_LE_EXT_SCAN_PHY_CODED            BTBIT(2)
...
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_FP_USE_LIST               BTBIT(0)
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_FP_REPORTS_DISABLED       BTBIT(1)
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_FP_FILTER_DUPLICATE       BTBIT(2)

#define BT_HCI_LE_PER_ADV_CREATE_SYNC_CTE_TYPE_NO_FILTERING     0
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_CTE_TYPE_NO_AOA           BTBIT(0)
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_CTE_TYPE_NO_AOD_1US       BTBIT(1)
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_CTE_TYPE_NO_AOD_2US       BTBIT(2)
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_CTE_TYPE_NO_CTE           BTBIT(3)
#define BT_HCI_LE_PER_ADV_CREATE_SYNC_CTE_TYPE_ONLY_CTE         BTBIT(4)
...
#define BT_HCI_LE_AOA_CTE_RSP                   BTBIT(0)
#define BT_HCI_LE_AOD_CTE_RSP_1US               BTBIT(1)
#define BT_HCI_LE_AOD_CTE_RSP_2US               BTBIT(2)
...
#define BT_HCI_LE_1US_AOD_TX                    BTBIT(0)
#define BT_HCI_LE_1US_AOD_RX                    BTBIT(1)
#define BT_HCI_LE_1US_AOA_RX                    BTBIT(2)
...
#define BT_HCI_LE_SET_PER_ADV_RECV_ENABLE_ENABLE           BTBIT(0)
#define BT_HCI_LE_SET_PER_ADV_RECV_ENABLE_FILTER_DUPLICATE BTBIT(1)
...
#define BT_HCI_LE_PAST_CTE_TYPE_NO_AOA           BTBIT(0)
#define BT_HCI_LE_PAST_CTE_TYPE_NO_AOD_1US       BTBIT(1)
#define BT_HCI_LE_PAST_CTE_TYPE_NO_AOD_2US       BTBIT(2)
#define BT_HCI_LE_PAST_CTE_TYPE_NO_CTE           BTBIT(3)
#define BT_HCI_LE_PAST_CTE_TYPE_ONLY_CTE         BTBIT(4)
...
#define BT_HCI_OP_LE_CS_INITIATOR_ROLE_MASK BTBIT(0)
#define BT_HCI_OP_LE_CS_REFLECTOR_ROLE_MASK BTBIT(1)
...
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_0_MASK BTBIT(0)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_2_MASK BTBIT(2)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_3_MASK BTBIT(3)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_4_MASK BTBIT(4)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_5_MASK BTBIT(5)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_6_MASK BTBIT(6)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_7_MASK BTBIT(7)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_8_MASK BTBIT(8)
#define BT_HCI_OP_LE_CS_TEST_OVERRIDE_CONFIG_10_MASK BTBIT(10)
...
#define BT_HCI_LE_FRAME_SPACE_UPDATE_PHY_1M_MASK    BTBIT(0)
#define BT_HCI_LE_FRAME_SPACE_UPDATE_PHY_2M_MASK    BTBIT(1)
#define BT_HCI_LE_FRAME_SPACE_UPDATE_PHY_CODED_MASK BTBIT(2)

#define BT_HCI_LE_FRAME_SPACE_UPDATE_SPACING_TYPE_IFS_ACL_CP_MASK BTBIT(0)
#define BT_HCI_LE_FRAME_SPACE_UPDATE_SPACING_TYPE_IFS_ACL_PC_MASK BTBIT(1)
#define BT_HCI_LE_FRAME_SPACE_UPDATE_SPACING_TYPE_MCES_MASK       BTBIT(2)
#define BT_HCI_LE_FRAME_SPACE_UPDATE_SPACING_TYPE_IFS_CIS_MASK    BTBIT(3)
#define BT_HCI_LE_FRAME_SPACE_UPDATE_SPACING_TYPE_MSS_CIS_MASK    BTBIT(4)
...
#define BT_HCI_LE_ADV_EVT_TYPE_CONN                 BTBIT(0)
#define BT_HCI_LE_ADV_EVT_TYPE_SCAN                 BTBIT(1)
#define BT_HCI_LE_ADV_EVT_TYPE_DIRECT               BTBIT(2)
#define BT_HCI_LE_ADV_EVT_TYPE_SCAN_RSP             BTBIT(3)
#define BT_HCI_LE_ADV_EVT_TYPE_LEGACY               BTBIT(4)
...
#define BT_HCI_LE_CS_INITIATOR_ROLE_MASK BTBIT(0)
#define BT_HCI_LE_CS_REFLECTOR_ROLE_MASK BTBIT(1)

#define BT_HCI_LE_CS_MODES_SUPPORTED_MODE_3_MASK BTBIT(0)

#define BT_HCI_LE_CS_RTT_AA_ONLY_N_10NS_MASK        BTBIT(0)
#define BT_HCI_LE_CS_RTT_SOUNDING_N_10NS_MASK       BTBIT(1)
#define BT_HCI_LE_CS_RTT_RANDOM_PAYLOAD_N_10NS_MASK BTBIT(2)

#define BT_HCI_LE_CS_NADM_SOUNDING_CAPABILITY_PHASE_BASED_MASK BTBIT(0)
#define BT_HCI_LE_CS_NADM_RANDOM_CAPABILITY_PHASE_BASED_MASK BTBIT(0)

#define BT_HCI_LE_CS_SYNC_PHYS_2M_MASK BTBIT(1)
#define BT_HCI_LE_CS_SYNC_PHYS_2M_2BT_MASK BTBIT(2)

#define BT_HCI_LE_CS_SUBFEATURE_NO_TX_FAE_MASK BTBIT(1)
#define BT_HCI_LE_CS_SUBFEATURE_CHSEL_ALG_3C_MASK BTBIT(2)
#define BT_HCI_LE_CS_SUBFEATURE_PBR_FROM_RTT_SOUNDING_SEQ_MASK BTBIT(3)

#define BT_HCI_LE_CS_T_IP1_TIME_10US_MASK BTBIT(0)
#define BT_HCI_LE_CS_T_IP1_TIME_20US_MASK BTBIT(1)
#define BT_HCI_LE_CS_T_IP1_TIME_30US_MASK BTBIT(2)
#define BT_HCI_LE_CS_T_IP1_TIME_40US_MASK BTBIT(3)
#define BT_HCI_LE_CS_T_IP1_TIME_50US_MASK BTBIT(4)
#define BT_HCI_LE_CS_T_IP1_TIME_60US_MASK BTBIT(5)
#define BT_HCI_LE_CS_T_IP1_TIME_80US_MASK BTBIT(6)

#define BT_HCI_LE_CS_T_IP2_TIME_10US_MASK BTBIT(0)
#define BT_HCI_LE_CS_T_IP2_TIME_20US_MASK BTBIT(1)
#define BT_HCI_LE_CS_T_IP2_TIME_30US_MASK BTBIT(2)
#define BT_HCI_LE_CS_T_IP2_TIME_40US_MASK BTBIT(3)
#define BT_HCI_LE_CS_T_IP2_TIME_50US_MASK BTBIT(4)
#define BT_HCI_LE_CS_T_IP2_TIME_60US_MASK BTBIT(5)
#define BT_HCI_LE_CS_T_IP2_TIME_80US_MASK BTBIT(6)

#define BT_HCI_LE_CS_T_FCS_TIME_15US_MASK   BTBIT(0)
#define BT_HCI_LE_CS_T_FCS_TIME_20US_MASK   BTBIT(1)
#define BT_HCI_LE_CS_T_FCS_TIME_30US_MASK   BTBIT(2)
#define BT_HCI_LE_CS_T_FCS_TIME_40US_MASK   BTBIT(3)
#define BT_HCI_LE_CS_T_FCS_TIME_50US_MASK   BTBIT(4)
#define BT_HCI_LE_CS_T_FCS_TIME_60US_MASK   BTBIT(5)
#define BT_HCI_LE_CS_T_FCS_TIME_80US_MASK   BTBIT(6)
#define BT_HCI_LE_CS_T_FCS_TIME_100US_MASK  BTBIT(7)
#define BT_HCI_LE_CS_T_FCS_TIME_1200US_MASK BTBIT(8)

#define BT_HCI_LE_CS_T_PM_TIME_10US_MASK BTBIT(0)
#define BT_HCI_LE_CS_T_PM_TIME_20US_MASK BTBIT(1)

#define BT_HCI_LE_CS_TX_SNR_CAPABILITY_18DB_MASK BTBIT(0)
#define BT_HCI_LE_CS_TX_SNR_CAPABILITY_21DB_MASK BTBIT(1)
#define BT_HCI_LE_CS_TX_SNR_CAPABILITY_24DB_MASK BTBIT(2)
#define BT_HCI_LE_CS_TX_SNR_CAPABILITY_27DB_MASK BTBIT(3)
#define BT_HCI_LE_CS_TX_SNR_CAPABILITY_30DB_MASK BTBIT(4)
...
#endif /* VSBT_INCLUDE_BLUETOOTH_HCI_TYPES_H_ */
