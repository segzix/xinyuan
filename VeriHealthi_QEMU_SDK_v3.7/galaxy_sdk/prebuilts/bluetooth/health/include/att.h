 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_ATT_H_
#define VSBT_INCLUDE_BLUETOOTH_ATT_H_
...
enum bt_att_chan_opt {
	...
	BT_ATT_CHAN_OPT_UNENHANCED_ONLY = BTBIT(0),
	/** Only Enhanced channels will be used  */
	BT_ATT_CHAN_OPT_ENHANCED_ONLY = BTBIT(1),
};
...
#endif /* VSBT_INCLUDE_BLUETOOTH_ATT_H_ */
