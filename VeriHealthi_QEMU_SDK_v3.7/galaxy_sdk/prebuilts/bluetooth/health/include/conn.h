 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_CONN_H_
#define VSBT_INCLUDE_BLUETOOTH_CONN_H_
...
enum {
	...
	BT_CONN_LE_PHY_OPT_CODED_S2  = BTBIT(0),

	/** LE Coded using S=8 coding preferred when transmitting. */
	BT_CONN_LE_PHY_OPT_CODED_S8  = BTBIT(1),
};
...
enum __packed bt_conn_type {
	/** LE Connection Type */
	BT_CONN_TYPE_LE = BTBIT(0),
	/** BR/EDR Connection Type */
	BT_CONN_TYPE_BR = BTBIT(1),
	/** SCO Connection Type */
	BT_CONN_TYPE_SCO = BTBIT(2),
	/** ISO Connection Type */
	BT_CONN_TYPE_ISO = BTBIT(3),
	/** All Connection Type */
...
typedef enum __packed {
	 ...
	 *  security level.
	 */
	BT_SECURITY_FORCE_PAIR = BTBIT(7),
} bt_security_t;

/** Security Info Flags. */
enum bt_security_flag {
	/** Paired with Secure Connections. */
	BT_SECURITY_FLAG_SC = BTBIT(0),
	/** Paired with Out of Band method. */
	BT_SECURITY_FLAG_OOB = BTBIT(1),
};
...
#endif /* VSBT_INCLUDE_BLUETOOTH_CONN_H_ */
