 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_AUDIO_AUDIO_H_
#define VSBT_INCLUDE_BLUETOOTH_AUDIO_AUDIO_H_
...
enum bt_audio_codec_cap_freq {
    ...
    BT_AUDIO_CODEC_CAP_FREQ_8KHZ = BTBIT(0),

    /** 11.025 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_11KHZ = BTBIT(1),

    /** 16 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_16KHZ = BTBIT(2),

    /** 22.05 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_22KHZ = BTBIT(3),

    /** 24 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_24KHZ = BTBIT(4),

    /** 32 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_32KHZ = BTBIT(5),

    /** 44.1 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_44KHZ = BTBIT(6),

    /** 48 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_48KHZ = BTBIT(7),

    /** 88.2 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_88KHZ = BTBIT(8),

    /** 96 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_96KHZ = BTBIT(9),

    /** 176.4 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_176KHZ = BTBIT(10),

    /** 192 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_192KHZ = BTBIT(11),

    /** 384 Khz sampling frequency */
    BT_AUDIO_CODEC_CAP_FREQ_384KHZ = BTBIT(12),

    /** Any frequency capability */
    BT_AUDIO_CODEC_CAP_FREQ_ANY = (BT_AUDIO_CODEC_CAP_FREQ_8KHZ | BT_AUDIO_CODEC_CAP_FREQ_11KHZ |
...
enum bt_audio_codec_cap_frame_dur {
    ...
    BT_AUDIO_CODEC_CAP_DURATION_7_5 = BTBIT(0),

    /** 10 msec frame duration capability */
    BT_AUDIO_CODEC_CAP_DURATION_10 = BTBIT(1),
     ...
     */
    BT_AUDIO_CODEC_CAP_DURATION_PREFER_7_5 = BTBIT(4),
     ...
     */
    BT_AUDIO_CODEC_CAP_DURATION_PREFER_10 = BTBIT(5),
};

/** Supported audio capabilities channel count bitfield */
enum bt_audio_codec_cap_chan_count {
    /** Supporting 1 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_1 = BTBIT(0),

    /** Supporting 2 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_2 = BTBIT(1),

    /** Supporting 3 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_3 = BTBIT(2),

    /** Supporting 4 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_4 = BTBIT(3),

    /** Supporting 5 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_5 = BTBIT(4),

    /** Supporting 6 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_6 = BTBIT(5),

    /** Supporting 7 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_7 = BTBIT(6),

    /** Supporting 8 channel */
    BT_AUDIO_CODEC_CAP_CHAN_COUNT_8 = BTBIT(7),
...
#define BT_AUDIO_CODEC_CAP_CHAN_COUNT_SUPPORT(...) \
    ((enum bt_audio_codec_cap_chan_count)((FOR_EACH(BTBIT, (|), __VA_ARGS__)) >> 1))
...
enum bt_audio_context {
     ...
     */
    BT_AUDIO_CONTEXT_TYPE_UNSPECIFIED = BTBIT(0),
    /**
     ...
     */
    BT_AUDIO_CONTEXT_TYPE_CONVERSATIONAL = BTBIT(1),
    /** Media, for example, music playback, radio, podcast or movie soundtrack, or tv audio */
    BT_AUDIO_CONTEXT_TYPE_MEDIA = BTBIT(2),
    /**
     ...
     */
    BT_AUDIO_CONTEXT_TYPE_RINGTONE = BTBIT(9),
    /**
     ...
     */
    BT_AUDIO_CONTEXT_TYPE_ALERTS = BTBIT(10),
    /** Emergency alarm Emergency sounds, for example, fire alarms or other urgent alerts */
    BT_AUDIO_CONTEXT_TYPE_EMERGENCY_ALARM = BTBIT(11),
};
...
#define BT_AUDIO_CONTEXT_TYPE_ANY                                                   \
    (BT_AUDIO_CONTEXT_TYPE_UNSPECIFIED | BT_AUDIO_CONTEXT_TYPE_CONVERSATIONAL |     \
     ...
     BT_AUDIO_CONTEXT_TYPE_INSTRUCTIONAL | BT_AUDIO_CONTEXT_TYPE_VOICE_ASSISTANTS | \
     BT_AUDIO_CONTEXT_TYPE_LIVE | BT_AUDIO_CONTEXT_TYPE_SOUND_EFFECTS |             \
     BT_AUDIO_CONTEXT_TYPE_NOTIFICATIONS | BT_AUDIO_CONTEXT_TYPE_RINGTONE |         \
     BT_AUDIO_CONTEXT_TYPE_ALERTS | BT_AUDIO_CONTEXT_TYPE_EMERGENCY_ALARM)
...
enum bt_audio_location {
    ...
    /** Front Left */
    BT_AUDIO_LOCATION_FRONT_LEFT = BTBIT(0),
    /** Front Right */
    BT_AUDIO_LOCATION_FRONT_RIGHT = BTBIT(1),
    /** Front Center */
    BT_AUDIO_LOCATION_FRONT_CENTER = BTBIT(2),
    /** Low Frequency Effects 1 */
    BT_AUDIO_LOCATION_LOW_FREQ_EFFECTS_1 = BTBIT(3),
    /** Back Left */
    BT_AUDIO_LOCATION_BACK_LEFT = BTBIT(4),
    /** Back Right */
    BT_AUDIO_LOCATION_BACK_RIGHT = BTBIT(5),
    /** Front Left of Center */
    BT_AUDIO_LOCATION_FRONT_LEFT_OF_CENTER = BTBIT(6),
    /** Front Right of Center */
    BT_AUDIO_LOCATION_FRONT_RIGHT_OF_CENTER = BTBIT(7),
    /** Back Center */
    BT_AUDIO_LOCATION_BACK_CENTER = BTBIT(8),
    /** Low Frequency Effects 2 */
    BT_AUDIO_LOCATION_LOW_FREQ_EFFECTS_2 = BTBIT(9),
    /** Side Left */
    BT_AUDIO_LOCATION_SIDE_LEFT = BTBIT(10),
    /** Side Right */
    BT_AUDIO_LOCATION_SIDE_RIGHT = BTBIT(11),
    /** Top Front Left */
    BT_AUDIO_LOCATION_TOP_FRONT_LEFT = BTBIT(12),
    /** Top Front Right */
    BT_AUDIO_LOCATION_TOP_FRONT_RIGHT = BTBIT(13),
    /** Top Front Center */
    BT_AUDIO_LOCATION_TOP_FRONT_CENTER = BTBIT(14),
    /** Top Center */
    BT_AUDIO_LOCATION_TOP_CENTER = BTBIT(15),
    /** Top Back Left */
    BT_AUDIO_LOCATION_TOP_BACK_LEFT = BTBIT(16),
    /** Top Back Right */
    BT_AUDIO_LOCATION_TOP_BACK_RIGHT = BTBIT(17),
    /** Top Side Left */
    BT_AUDIO_LOCATION_TOP_SIDE_LEFT = BTBIT(18),
    /** Top Side Right */
    BT_AUDIO_LOCATION_TOP_SIDE_RIGHT = BTBIT(19),
    /** Top Back Center */
    BT_AUDIO_LOCATION_TOP_BACK_CENTER = BTBIT(20),
    /** Bottom Front Center */
    BT_AUDIO_LOCATION_BOTTOM_FRONT_CENTER = BTBIT(21),
    /** Bottom Front Left */
    BT_AUDIO_LOCATION_BOTTOM_FRONT_LEFT = BTBIT(22),
    /** Bottom Front Right */
    BT_AUDIO_LOCATION_BOTTOM_FRONT_RIGHT = BTBIT(23),
    /** Front Left Wide */
    BT_AUDIO_LOCATION_FRONT_LEFT_WIDE = BTBIT(24),
    /** Front Right Wide */
    BT_AUDIO_LOCATION_FRONT_RIGHT_WIDE = BTBIT(25),
    /** Left Surround */
    BT_AUDIO_LOCATION_LEFT_SURROUND = BTBIT(26),
    /** Right Surround */
    BT_AUDIO_LOCATION_RIGHT_SURROUND = BTBIT(27),
};
...
#define BT_AUDIO_LOCATION_ANY                                                           \
    (BT_AUDIO_LOCATION_FRONT_LEFT | BT_AUDIO_LOCATION_FRONT_RIGHT |                     \
     BT_AUDIO_LOCATION_FRONT_CENTER | BT_AUDIO_LOCATION_LOW_FREQ_EFFECTS_1 |            \
     BT_AUDIO_LOCATION_BACK_LEFT | BT_AUDIO_LOCATION_BACK_RIGHT |                       \
     BT_AUDIO_LOCATION_FRONT_LEFT_OF_CENTER | BT_AUDIO_LOCATION_FRONT_RIGHT_OF_CENTER | \
     BT_AUDIO_LOCATION_BACK_CENTER | BT_AUDIO_LOCATION_LOW_FREQ_EFFECTS_2 |             \
     BT_AUDIO_LOCATION_SIDE_LEFT | BT_AUDIO_LOCATION_SIDE_RIGHT |                       \
     BT_AUDIO_LOCATION_TOP_FRONT_LEFT | BT_AUDIO_LOCATION_TOP_FRONT_RIGHT |             \
     BT_AUDIO_LOCATION_TOP_FRONT_CENTER | BT_AUDIO_LOCATION_TOP_CENTER |                \
     BT_AUDIO_LOCATION_TOP_BACK_LEFT | BT_AUDIO_LOCATION_TOP_BACK_RIGHT |               \
     BT_AUDIO_LOCATION_TOP_SIDE_LEFT | BT_AUDIO_LOCATION_TOP_SIDE_RIGHT |               \
     BT_AUDIO_LOCATION_TOP_BACK_CENTER | BT_AUDIO_LOCATION_BOTTOM_FRONT_CENTER |        \
     BT_AUDIO_LOCATION_BOTTOM_FRONT_LEFT | BT_AUDIO_LOCATION_BOTTOM_FRONT_RIGHT |       \
     BT_AUDIO_LOCATION_FRONT_LEFT_WIDE | BT_AUDIO_LOCATION_FRONT_RIGHT_WIDE |           \
     BT_AUDIO_LOCATION_LEFT_SURROUND | BT_AUDIO_LOCATION_RIGHT_SURROUND)
...
enum {
    /** LE 1M PHY */
    BT_AUDIO_CODEC_QOS_1M = BTBIT(0),
    /** LE 2M PHY */
    BT_AUDIO_CODEC_QOS_2M = BTBIT(1),
    /** LE Coded PHY */
    BT_AUDIO_CODEC_QOS_CODED = BTBIT(2),
};
...
#define BT_AUDIO_CODEC_QOS_FRAMED(_interval, _sdu, _rtn, _latency, _pd)                           \
    BT_AUDIO_CODEC_QOS(_interval, BT_AUDIO_CODEC_QOS_FRAMING_FRAMED, BT_AUDIO_CODEC_QOS_2M, _sdu, \
                       _rtn, _latency, _pd)
 ...
 */
#define BT_BAP_QOS_CFG_UNFRAMED(_unframed_supported, _phy, _rtn, _latency, _pd_min, _pd_max, \
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AUDIO_H_ */
