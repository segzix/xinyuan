...
#ifndef VSBT_INCLUDE_BLUETOOTH_AUDIO_MCS_H_
#define VSBT_INCLUDE_BLUETOOTH_AUDIO_MCS_H_
 ...
 */
/** A single track is played once; there is no next track. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_SINGLE_ONCE BTBIT(0)
/** A single track is played repeatedly; the next track is the current track. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_SINGLE_REPEAT BTBIT(1)
/** The tracks within a group are played once in track order. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_INORDER_ONCE BTBIT(2)
/** The tracks within a group are played in track order repeatedly. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_INORDER_REPEAT BTBIT(3)
/** The tracks within a group are played once only from the oldest first. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_OLDEST_ONCE BTBIT(4)
/** The tracks within a group are played from the oldest first repeatedly. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_OLDEST_REPEAT BTBIT(5)
/** The tracks within a group are played once only from the newest first. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_NEWEST_ONCE BTBIT(6)
/** The tracks within a group are played from the newest first repeatedly. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_NEWEST_REPEAT BTBIT(7)
/** The tracks within a group are played in random order once. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_SHUFFLE_ONCE BTBIT(8)
/** The tracks within a group are played in random order repeatedly. */
#define BT_MCS_PLAYING_ORDERS_SUPPORTED_SHUFFLE_REPEAT BTBIT(9)
/** @} */
...
#define BT_MCS_OPC_SUP_PLAY BTBIT(0)
/** Support the Pause opcode */
#define BT_MCS_OPC_SUP_PAUSE BTBIT(1)
/** Support the Fast Rewind opcode */
#define BT_MCS_OPC_SUP_FAST_REWIND BTBIT(2)
/** Support the Fast Forward opcode */
#define BT_MCS_OPC_SUP_FAST_FORWARD BTBIT(3)
/** Support the Stop opcode */
#define BT_MCS_OPC_SUP_STOP BTBIT(4)

/** Support the Move Relative opcode */
#define BT_MCS_OPC_SUP_MOVE_RELATIVE BTBIT(5)

/** Support the Previous Segment opcode */
#define BT_MCS_OPC_SUP_PREV_SEGMENT BTBIT(6)
/** Support the Next Segment opcode */
#define BT_MCS_OPC_SUP_NEXT_SEGMENT BTBIT(7)
/** Support the First Segment opcode */
#define BT_MCS_OPC_SUP_FIRST_SEGMENT BTBIT(8)
/** Support the Last Segment opcode */
#define BT_MCS_OPC_SUP_LAST_SEGMENT BTBIT(9)
/** Support the Goto Segment opcode */
#define BT_MCS_OPC_SUP_GOTO_SEGMENT BTBIT(10)

/** Support the Previous Track opcode */
#define BT_MCS_OPC_SUP_PREV_TRACK BTBIT(11)
/** Support the Next Track opcode */
#define BT_MCS_OPC_SUP_NEXT_TRACK BTBIT(12)
/** Support the First Track opcode */
#define BT_MCS_OPC_SUP_FIRST_TRACK BTBIT(13)
/** Support the Last Track opcode */
#define BT_MCS_OPC_SUP_LAST_TRACK BTBIT(14)
/** Support the Goto Track opcode */
#define BT_MCS_OPC_SUP_GOTO_TRACK BTBIT(15)

/** Support the Previous Group opcode */
#define BT_MCS_OPC_SUP_PREV_GROUP BTBIT(16)
/** Support the Next Group opcode */
#define BT_MCS_OPC_SUP_NEXT_GROUP BTBIT(17)
/** Support the First Group opcode */
#define BT_MCS_OPC_SUP_FIRST_GROUP BTBIT(18)
/** Support the Last Group opcode */
#define BT_MCS_OPC_SUP_LAST_GROUP BTBIT(19)
/** Support the Goto Group opcode */
#define BT_MCS_OPC_SUP_GOTO_GROUP BTBIT(20)
/** @} */
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AUDIO_MCS_H_ */
