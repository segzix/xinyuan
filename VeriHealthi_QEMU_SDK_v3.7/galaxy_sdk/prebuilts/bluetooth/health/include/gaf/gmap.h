...
#ifndef VSBT_INCLUDE_BLUETOOTH_AUDIO_GMAP_
#define VSBT_INCLUDE_BLUETOOTH_AUDIO_GMAP_
...
enum bt_gmap_ugg_feat {
     ...
     */
    BT_GMAP_UGG_FEAT_MULTIPLEX = BTBIT(0),
    /**
     * @brief 96 kbps source support
     *
     * Requires @kconfig{CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SRC_COUNT} > 0
     */
    BT_GMAP_UGG_FEAT_96KBPS_SOURCE = BTBIT(1),
    /**
     ...
     */
    BT_GMAP_UGG_FEAT_MULTISINK = BTBIT(2),
};
...
enum bt_gmap_bgr_feat {
     ...
     */
    BT_GMAP_BGR_FEAT_MULTISINK = BTBIT(0),
    /** @brief Support for receiving multiple LC3 codec frames per block in an SDU */
    BT_GMAP_BGR_FEAT_MULTIPLEX = BTBIT(1),
};
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AUDIO_GMAP_ */
