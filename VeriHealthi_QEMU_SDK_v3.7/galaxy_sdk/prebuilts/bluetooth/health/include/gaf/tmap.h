...
#ifndef VSBT_INCLUDE_BLUETOOTH_AUDIO_TMAP_
#define VSBT_INCLUDE_BLUETOOTH_AUDIO_TMAP_
...
#define BT_TMAP_UMS_SUPPORTED                                                                   \
    (IS_ENABLED(CONFIG_BT_CAP_INITIATOR) && IS_ENABLED(CONFIG_BT_BAP_UNICAST_CLIENT_ASE_SNK) && \
     IS_ENABLED(CONFIG_BT_VCP_VOL_CTLR) && IS_ENABLED(CONFIG_BT_MCS))
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AUDIO_TMAP_ */
