 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_GATT_H_
#define VSBT_INCLUDE_BLUETOOTH_GATT_H_
...
enum bt_gatt_perm {
     ...
     *  access.
     */
    BT_GATT_PERM_READ_AUTHEN = BTBIT(4),
     ...
     *  access.
     */
    BT_GATT_PERM_WRITE_AUTHEN = BTBIT(5),
     ...
     */
    BT_GATT_PERM_PREPARE_WRITE = BTBIT(6),
     ...
     */
    BT_GATT_PERM_READ_LESC = BTBIT(7),
     ...
     */
    BT_GATT_PERM_WRITE_LESC = BTBIT(8),
};
...
enum bt_gatt_attr_write_flag {
     ...
     */
    BT_GATT_WRITE_FLAG_PREPARE = BTBIT(0),
     ...
     */
    BT_GATT_WRITE_FLAG_CMD = BTBIT(1),
     ...
     */
    BT_GATT_WRITE_FLAG_EXECUTE = BTBIT(2),
};
 ...
 *
 *  @return 0 in case of success or negative value in case of error.
 *            -ENOMEM in case of internal buffer is exhausted. User should retry
 *            sending notification after a short period to allow the internal
 ...
 *  @retval -ENOMEM
 *    In case of internal buffer is exhausted. User should retry
 *    sending notification after a short period to allow the internal
 *    buffer to be released.
 */
 ...
 *  In case of internal buffer is exhausted. User should retry sending
 *  notification after a short period to allow the internal buffer to be
 *  released.
 *
...
#endif /* VSBT_INCLUDE_BLUETOOTH_GATT_H_ */
