 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_L2CAP_H_
#define VSBT_INCLUDE_BLUETOOTH_L2CAP_H_
...
#if defined(CONFIG_BT_VS_REHANDLE_MECHANISM)
	/**
	 * A packet-rehandle work is added in this structure. When buffer
	 * allocating error occurs, this work will be resubmitted to
	 * the syswq and handled again.
	 */
	struct k_work       l2cap_pkt_rehandle_work;
#endif
...
#endif /* VSBT_INCLUDE_BLUETOOTH_L2CAP_H_ */
