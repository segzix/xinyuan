...
#ifndef VSBT_INCLUDE_BLUETOOTH_AVRCP_H_
#define VSBT_INCLUDE_BLUETOOTH_AVRCP_H_
...
struct bt_avrcp_ct_cb {
	 ...
	 */
	void (*get_caps)(struct bt_avrcp_ct *ct, uint8_t tid, uint8_t status, struct net_buf_simple *buf);
	 ...
	 */
	void (*set_browsed_player)(struct bt_avrcp_ct *ct, uint8_t tid, struct net_buf_simple *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*get_folder_items)(struct bt_avrcp_ct *ct, uint8_t tid, struct net_buf_simple *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*get_item_attrs)(struct bt_avrcp_ct *ct, uint8_t tid, struct net_buf_simple *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*get_total_number_of_items)(struct bt_avrcp_ct *ct, uint8_t tid, struct net_buf_simple *buf);
	 ...
	 *             Note that the data is encoded in big-endian format.
	 */
	void (*search)(struct bt_avrcp_ct *ct, uint8_t tid, struct net_buf_simple *buf);
	...
	void (*get_player_app_setting_attr_text)(struct bt_avrcp_ct *ct, uint8_t tid,
						 uint8_t status, struct net_buf_simple *buf);
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AVRCP_H_ */
