...
/**
 * @brief Battery Service (BAS) demonstration.
 * @details This sample demonstrates the usage of Battery Service (BAS) GATT service
 *          for reporting battery level information over Bluetooth.
 * @defgroup bas BAS
