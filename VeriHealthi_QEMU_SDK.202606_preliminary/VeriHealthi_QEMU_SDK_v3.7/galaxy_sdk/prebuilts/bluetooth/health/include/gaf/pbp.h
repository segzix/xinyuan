...
#ifndef VSBT_INCLUDE_BLUETOOTH_AUDIO_PBP_
#define VSBT_INCLUDE_BLUETOOTH_AUDIO_PBP_
...
enum bt_pbp_announcement_feature {
    ...
    BT_PBP_ANNOUNCEMENT_FEATURE_ENCRYPTION = BTBIT(0),
    /** Standard Quality Public Broadcast Audio configuration */
    BT_PBP_ANNOUNCEMENT_FEATURE_STANDARD_QUALITY = BTBIT(1),
    /** High Quality Public Broadcast Audio configuration */
    BT_PBP_ANNOUNCEMENT_FEATURE_HIGH_QUALITY = BTBIT(2),
};
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AUDIO_PBP_ */
