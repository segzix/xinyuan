...
#ifndef VSBT_SUBSYS_BLUETOOTH_AUDIO_CSIP_H_
#define VSBT_SUBSYS_BLUETOOTH_AUDIO_CSIP_H_
...
struct bt_csip_set_member_cb {
     ...
     *
     */
    void (*lock_changed)(struct bt_conn *conn, struct bt_csip_set_member_svc_inst *svc_inst,
                         bool locked);
...
typedef void (*bt_csip_set_coordinator_discover_cb)(
    struct bt_conn *conn, const struct bt_csip_set_coordinator_set_member *member, int err,
    size_t set_count);
 ...
 */
struct bt_csip_set_coordinator_set_member *bt_csip_set_coordinator_set_member_by_conn(
...
int bt_csip_set_coordinator_ordered_access(
    const struct bt_csip_set_coordinator_set_member *members[], uint8_t count,
    const struct bt_csip_set_coordinator_set_info *set_info,
...
#endif /* VSBT_SUBSYS_BLUETOOTH_AUDIO_CSIP_H_ */
