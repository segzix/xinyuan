...
#ifndef VSBT_INCLUDE_BLUETOOTH_AUDIO_HAS_H_
#define VSBT_INCLUDE_BLUETOOTH_AUDIO_HAS_H_
...
enum bt_has_properties {
    ...
    BT_HAS_PROP_WRITABLE = BTBIT(0),

    /** Preset availability */
    BT_HAS_PROP_AVAILABLE = BTBIT(1),
};

/** Hearing Aid device capabilities */
enum bt_has_capabilities {
    /** Indicate support for presets */
    BT_HAS_PRESET_SUPPORT = BTBIT(0),
};
...
struct bt_has_client_cb {
     ...
     */
    void (*preset_read_rsp)(struct bt_has *has, int err, const struct bt_has_preset_record *record,
                            bool is_last);
...
#endif /* VSBT_INCLUDE_BLUETOOTH_AUDIO_HAS_H_ */
