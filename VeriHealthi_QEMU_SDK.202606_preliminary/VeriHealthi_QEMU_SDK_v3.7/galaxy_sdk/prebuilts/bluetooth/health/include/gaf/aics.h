...
#ifndef VSBT_INCLUDE_BLUETOOTH_SERVICES_AICS_H_
#define VSBT_INCLUDE_BLUETOOTH_SERVICES_AICS_H_
 ...
 */
typedef void (*bt_aics_state_cb)(struct bt_aics *inst, int err, int8_t gain, uint8_t mute,
                                 uint8_t mode);
 ...
 */
typedef void (*bt_aics_gain_setting_cb)(struct bt_aics *inst, int err, uint8_t units,
...
#endif /* VSBT_INCLUDE_BLUETOOTH_SERVICES_AICS_H_ */
