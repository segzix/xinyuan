 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_ISO_H_
#define VSBT_INCLUDE_BLUETOOTH_ISO_H_
...
struct bt_iso_big_sync_param {
	 ...
	 *  BTBIT(1) that represents index 0x01. To synchronize to e.g. BIS
	 *  indexes 0x01 and 0x02, the bitfield value should be BTBIT(1) | BTBIT(2).
	 */
...
#endif /* VSBT_INCLUDE_BLUETOOTH_ISO_H_ */
