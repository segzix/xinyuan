 ...
 */
#ifndef VSBT_INCLUDE_BLUETOOTH_A2DP_H_
#define VSBT_INCLUDE_BLUETOOTH_A2DP_H_
...
struct bt_a2dp_ep {
	...
	/** AVDTP Stream information handled by VSBT internally*/
	uint8_t avdtp_sep_internal[0xd0];
...
struct bt_a2dp_stream_ops {
	 ...
	 */
	void (*recv)(struct bt_a2dp_stream *stream, struct net_buf_simple *buf, uint16_t seq_num,
		     uint32_t ts);
#endif
};
...
#endif /* VSBT_INCLUDE_BLUETOOTH_A2DP_H_ */
